...
import type { PuddleStorefrontAPI } from './client';
...
export type ParseResponse<T> = (client: PuddleStorefrontAPI, props: APIResponseProps) => T | Promise<T>;
...
export class APIPromise<T> extends Promise<T> {
  ...
  constructor(
    private readonly client: PuddleStorefrontAPI,
